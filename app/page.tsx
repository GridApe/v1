...
export default function Dashboard() {
  return (
    <div className="p-4 md:p-6 lg:p-8 bg-gray-50 min-h-screen rounded-lg">
      ...
      <div className="mb-12 grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 max-w-[800px] mt-12">
        {[
          ...
          <motion.div
            ...
            className="rounded-xl bg-white p-4 md:p-6 shadow-sm cursor-pointer hover:shadow-md transition-shadow"
          >
      ...
      <div className="mb-12">
        <h2 className="mb-6 text-xl font-semibold text-[#1E0E4E]">
          Email performance
        </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="order-2 lg:order-1">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-semibold text-[#1E0E4E]">
